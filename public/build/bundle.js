...
var app = (function () {
    ...
    function create_fragment$A(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "¡Esta página no existe! Escriba de nuevo su petición";
    ...
    function create_fragment$z(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = space();
    			h30 = element("h3");
    			h30.textContent = "Estadísticas de Ansiedad";
    			t20 = space();
    			p1 = element("p");
    			...
    			t28 = space();
    			h31 = element("h3");
    			h31.textContent = "Estadísticas de Ansiedad";
    			t30 = space();
    			p2 = element("p");
    ...
    function create_default_slot_8$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Estadísticas acerca de los datos recogidos por ansiedad\r\n                        en las comunidades autónomas de España.");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    function create_default_slot_13$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Integraciones y Gráficos base de anxiety_stats");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h6 = element("h6");
    			h6.textContent = "Atención: si intenta insertar los datos de un país que contenga más\r\n            de una palabra, debe insertar una \"_\" en lugar de \" \".";
    			t4 = space();
    			p = element("p");
    			p.textContent = "Por ejemplo: si quiere insertar los datos del país \"Spain Murcia\"\r\n            debe poner \"Spain_Murcia\".";
    			t6 = space();
    ...
    function create_default_slot_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			tr0 = element("tr");
    			th0 = element("th");
    			th0.textContent = "País (Comund. Autónoma)";
    			t1 = space();
    			th1 = element("th");
    			th1.textContent = "Año";
    			t3 = space();
    			...
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Datos de Ansiedad en Población";
    			t9 = space();
    			th5 = element("th");
    ...
    // (346:4) <Pagination style="float:right;" ariaLabel="Cambio de página">
    function create_default_slot_3$7(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(346:4) <Pagination style=\\\"float:right;\\\" ariaLabel=\\\"Cambio de página\\\">",
    		ctx
    	});
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	async function insertanxiety() {
    		...
    		if (isNaN(newAnxiety.year) || isNaN(newAnxiety.anxiety_men) || isNaN(newAnxiety.anxiety_women) || isNaN(newAnxiety.anxiety_population) || newAnxiety.country === "" || newAnxiety.year === "") {
    			...
    			$$invalidate(8, errorMsg = "No puede introducir campos en blanco o campos que no sean numéricos");
    		} else {
    			await fetch("/api/v2/anxiety_stats", {
    				...
    				if (res.ok) {
    					...
    					$$invalidate(7, okMsg = false);
    					$$invalidate(8, errorMsg = "No puede introducirse un dato con mismo año y país debido a que ya existe uno en la base de datos");
    				}
    			});
    		}
    	}
    	...
    	async function searchanxiety(country, year) {
    		...
    		if (res.ok) {
    			...
    			if (anxiety.length > 0) {
    				...
    				$$invalidate(7, okMsg = false);
    				$$invalidate(8, errorMsg = "No se ha obtenido ningún resultado");
    			}
    		} else {
    			console.log("ERROR");
    		}
    ...
    function create_default_slot_1$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Índice de ansiedad por hombre";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "Índice de ansiedad por mujer";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Índice de ansiedad en población";
    			t9 = space();
    			th5 = element("th");
    			th5.textContent = "Acciones";
    			t11 = space();
    	...
    	async function updateanxietyStat() {
    		...
    		await fetch(API_ANXIETY_STATS + "/" + params.country + "/" + params.year, {
    			...
    			if (res.ok) {
    				...
    				$$invalidate(6, correctMsg = `El dato con país: ${params.country} y año: ${params.year} ha sido actualizado correctamente.`);
    				getanxietyStat();
    			} else if (res.status == 404) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			div = element("div");
    			div.textContent = "Integración SOS: Covid India";
    			...
    			add_location(div, file$8, 119, 4, 3473);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			div = element("div");
    			div.textContent = "Integración SOS: Sanity Stats";
    			if (!src_url_equal(script.src, script_src_value = "https://cdn.zingchart.com/zingchart.min.js")) attr_dev(script, "src", script_src_value);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			i = element("i");
    			i.textContent = "En esta simple gráfica de lineas podemos observar los datos de\r\n                Ansiedad en las CC.AA en España en el año 2017.";
    			if (!src_url_equal(script0.src, script0_src_value = "https://code.highcharts.com/highcharts.js")) attr_dev(script0, "src", script0_src_value);
    ...
    async function loadGraph() {
    	...
    	Highcharts.chart("container", {
    		...
    		tooltip: {
    			headerFormat: "",
    			pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' + "Población Afectada: <b>{point.y}</b><br/>" + "Año: <b>{point.z}</b><br/>"
    		},
    		series: [
    			{
